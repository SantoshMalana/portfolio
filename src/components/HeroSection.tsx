  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          Crafting scalable, real-time web experiences with modern architectures.
          Passionate about{' '}
          <span className="text-foreground/80">WebRTC</span>,{' '}
          <span className="text-foreground/80">distributed systems</span> &amp; beautiful interfaces.
        </motion.p>
